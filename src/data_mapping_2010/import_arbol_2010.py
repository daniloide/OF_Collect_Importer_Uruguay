        ...
        for row in datareader:
            ...
            if id in survey.plots.keys():
                ...
                if row.has_key('diametro'):
                    survey.plots[id].trees[arbol_id].arbol_parcela = tools_lib.convert_arbol_diametro(row['diametro'])
                else:
                    survey.plots[id].trees[arbol_id].arbol_parcela = 5
                survey.plots[id].trees[arbol_id].arbol_unico_id = ''
                ...
                if no_tree_id is True:
                    ...
                    survey.plots[id].trees[arbol_id].stems[stem_id].observacion = \
                        survey.plots[id].trees[arbol_id].stems[stem_id].observacion + 'No tree id found in the data'
                ...
                survey.plots[id].trees[arbol_id].stems[stem_id].corteza_espesor_unit_name = ''
                survey.plots[id].trees[arbol_id].stems[stem_id].rumbo_unit_name = None
                ...
                if bosque_nativo:
                    # TODO Estrato needs to be updated once the information how thw mapping should be done is available
                    survey.plots[id].trees[arbol_id].stems[stem_id].estrado = tools_lib.\
                    ...
                    if row.has_key('forma') and  row['forma'] not in ['',' ']:
                        ...
                        if forma in ['1','2','3','4','5','6']:
                                survey.plots[id].trees[arbol_id].stems[stem_id].forma= forma
                        else:
                    ...
                    survey.plots[id].trees[arbol_id].stems[stem_id].corteza_espesor = tools_lib.import_variable(row, 'espesor', 'float', id)
